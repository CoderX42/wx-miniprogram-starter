...
<section class="home-hero" aria-labelledby="hero-name">
  ...
  <h1 id="hero-name" class="home-hero__name">wx-miniprogram<span class="accent">.</span></h1>
  <p class="home-hero__text">通用微信小程序项目骨架</p>
  <p class="home-hero__tagline">跨技术栈 core + 原生 / uni-app 双模板 — 让新项目从「搭建脚手架」变成「替换业务」。</p>
